    ...
    <div class="tw:min-h-screen tw:bg-gray-50 tw:flex tw:justify-center tw:py-4 tw:px-3 tw:md:py-10 tw:md:px-6">
        <div class="tw:w-full tw:max-w-7xl tw:min-w-0 tw:flex tw:flex-col tw:md:flex-row tw:gap-4 tw:md:gap-6">
            ...
            <div class="tw:hidden tw:md:block">
                <EventSidebar sidebar-kind="talents" :menuItems="menuItems" @back="handleBack" @event-selected="handleEventSelected" @chatbox-click="handleChatboxClick" />
            </div>
            ...
            <div class="tw:flex-1 tw:min-w-0 tw:overflow-x-hidden tw:bg-[#F6F1E7] tw:rounded-xl tw:md:rounded-3xl tw:shadow-sm tw:p-4 tw:md:p-6">
                <div class="tw:bg-white tw:rounded-2xl tw:p-5 tw:md:p-12">
                    <h1 class="tw:text-2xl tw:md:text-3xl tw:font-bold tw:text-[#2563eb] tw:mb-4 tw:md:mb-6">Talent Settings</h1>

                    <div class="tw:hidden tw:md:flex tw:flex-nowrap tw:items-end tw:gap-8 tw:border-b tw:border-gray-200 tw:mb-6 tw:overflow-x-visible tw:overflow-y-visible scrollbar-hide">
                    ...
                    <div class="tw:md:hidden tw:space-y-2 tw:mb-6">
                        <button v-for="tab in tabs" :key="`mobile-${tab.id}`" type="button" @click="activeTab = tab.id" :class="[
                            'tw:w-full tw:flex tw:items-center tw:justify-between tw:px-4 tw:py-3 tw:rounded-lg tw:border tw:transition-colors',
                            activeTab === tab.id ? 'tw:bg-blue-50 tw:border-blue-200 tw:text-[#2563eb]' : 'tw:bg-white tw:border-gray-200 tw:text-[#1E3A8A]'
                        ]">
                    ...
                    <div class="tw:transition-opacity tw:duration-300">
                        ...
                        <div v-if="activeTab === 'account'" class="tw:bg-[#F6F1E7] tw:rounded-lg tw:p-4 tw:md:p-8">
                            ...
                            <div class="tw:grid tw:grid-cols-1 tw:md:grid-cols-2 tw:gap-6">
                                ...
                                <div class="tw:bg-white tw:rounded-lg tw:p-4 tw:border tw:border-gray-200">
                                    <p class="tw:text-xs tw:text-gray-500 tw:uppercase tw:tracking-wide tw:mb-2">Profile
                                        Type</p>
                                    <p class="tw:text-gray-800 tw:font-medium tw:capitalize">{{ authStore.user.profile_type
                                    }}</p>
                                </div>
                                <div class="tw:bg-white tw:rounded-lg tw:p-4 tw:border tw:border-gray-200">
                                    <p class="tw:text-xs tw:text-gray-500 tw:uppercase tw:tracking-wide tw:mb-2">Account
                                        Type</p>
