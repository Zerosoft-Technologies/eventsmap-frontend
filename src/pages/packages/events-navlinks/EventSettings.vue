<template>
    <div class="tw:min-h-screen tw:bg-white tw:p-6">
        <div class="tw:max-w-5xl tw:mx-auto tw:bg-[#F6F1E7] tw:rounded-3xl tw:p-6">
                            ...
                            <div class="tw:grid tw:grid-cols-12 tw:gap-6">
                                ...
                                <div class="tw:col-span-8">
                                    ...
                                    <div
                                        ...
                                        <p class="tw:text-[#2563eb] tw:text-sm tw:mb-auto">Publish unlimited events and
                                            tickets
                                            for free!</p>
