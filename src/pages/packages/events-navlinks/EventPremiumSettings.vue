      ...
      <div class="tw:w-full tw:max-w-7xl tw:mx-auto">
        ...
        <div class="tw:mb-6 tw:px-1">
          ...
          <p class="tw:text-sm sm:tw:text-base tw:text-gray-600">
            Manage your premium event profile and preferences
          </p>
        </div>
          ...
          <template #default="{ activeTab }">
            ...
            >
              ...
              <div class="tw-space-y-4 tw:mb-6">
                <div
                  class="tw:bg-white tw:rounded-lg tw:p-4 tw:border tw:border-gray-200"
                >
                  ...
                  >
                    <div class="tw:flex tw:items-center tw:justify-between tw:gap-4">
                      <div class="tw:flex tw:gap-3 tw:items-center">
                        ...
                        <div>
                          <h4
                            class="tw:text-sm tw:font-semibold tw:text-gray-900 tw:mb-0.5"
                          >
                            Download Your Billing History
                          </h4>
                          <p class="tw:text-xs tw:text-gray-500">
...
import { Home, FileText, BarChart3, Settings, Calendar, MessageSquareText, ChevronDown, Download } from 'lucide-vue-next'
