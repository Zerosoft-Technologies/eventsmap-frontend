        ...
        <div class="tw:w-full tw:max-w-7xl tw:flex tw:flex-col tw:md:flex-row tw:gap-4 tw:md:gap-6">
            ...
            <div v-if="mobileSidebarOpen" class="tw:md:hidden tw:fixed tw:inset-0 tw:z-50">
                ...
                <div class="tw:absolute tw:left-0 tw:top-0 tw:h-screen tw:max-w-[92vw] tw:w-full tw:p-2">
                    <EventSidebar sidebar-kind="venues" :menuItems="menuItems" @back="handleBack" @event-selected="handleEventSelected" 
         ...
         tw:transition tw:whitespace-nowrap tw:shadow-sm">
            ...
            <!-- ================= RIGHT CARD ================= -->
            <div class="tw:flex-1 tw:bg-[#F6F1E7] tw:rounded-xl tw:md:rounded-3xl tw:shadow-sm tw:p-4 tw:md:p-8 tw:space-y-4 tw:md:space-y-6">
...
function setGalleryImagesFromVenue(venue) {
    ...
    if (Array.isArray(venue.additional_images)) {
        const urlList = Array.isArray(venue.additional_image_urls) ? venue.additional_image_urls : []
        for (let i = 0; i < venue.additional_images.length; i++) {
            const raw = venue.additional_images[i]
