...
import Report from '../pages/packages/eventsettings/EventReport.vue'
import SettingsPage from '../pages/packages/eventsettings/EventSettings.vue'
...
const routes: RouteRecordRaw[] = [
  ...
  { path: '/create-event-free/report', name: 'EventReport', component: Report },

  { path: '/create-event-free/settings', name: 'EventSettings', component: SettingsPage },
