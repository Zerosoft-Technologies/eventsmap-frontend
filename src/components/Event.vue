    ...
    <div class="tw:p-3 tw:space-y-2">
      ...
      <div class="tw:space-y-1.5">
        ...
        <div class="tw:flex tw:items-start tw:gap-2">
          ...
          <span class="tw:text-sm tw:text-[var(--primary-color)] tw:leading-snug">{{ event.formatted_date }}</span>
        </div>
        ...
        <div class="tw:flex tw:items-start tw:gap-2">
          ...
          <span class="tw:text-sm tw:text-[var(--primary-color)] tw:underline tw:cursor-pointer tw:leading-snug">{{ event.address }}</span>
        </div>
